...
const candidates = {
	"Amaan Sayyad":{
		...
		preferences: ["VP Communications", "VP Digital Media"]
	},
	"Angela Solanki":{
		name: "Angela Solanki",
		...
		preferences: ["VP Digital Media", "VP Conference - Campus Relations", "VP Campus Outreach"]
	},
	"Anhad Singh Sarna":{
		...
		preferences: ["VP Conference - Operations", "VP Digital Media"]
	},
	"Diya Khajuria":{
		name: "Diya Khajuria",
		...
		preferences: ["VP Admin", "VP Industry Outreach", "VP Digital Media"]
	},
	"Gurmanpreet Singh Tiwana":{
		...
		preferences: ["VP Industry Outreach", "VP Academics"]
	},
	"Jashanveer Singh Arora":{
		...
		preferences: ["VP Conference - Campus Relations"]
	},
	"Krupal Shah":{
		name: "Krupal Shah",
	...
	"MacKenzie Luong":{
		...
		preferences: ["VP Communications", "VP Campus Outreach"]
	},
	"Mark Maligalig":{
		name: "Mark Maligalig",
		email: "aasolank@ualberta.ca",
		...
		preferences: ["President", "VP Admin", "Conference Operations"]
	},
	"Ranbir singh":{
		name: "Ranbir singh",
		...
		preferences: ["VP Conference - Finance", "VP Communications", "VP Campus Outreach"]
	},
	"Ridham Singh":{
		name: "Ridham Singh",
	...
	"Clare Chen":{
		...
		preferences: ["VP Industry Outreach", "VP Campus Outreach", "VP Communications"]
	},
	Abstain: {
		name: "Abstain",
